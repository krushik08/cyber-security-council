...
import DubaiElectricityAndWaterAuthority from './pages/Port-Of-Fujairah';
...
import SmartZoo from './pages/ADNOC-Oil-And-Gas';
import SpaceCenter from './pages/space-center';
import SharjahMuseum from './pages/ADNOC-Oil-And-Gas';
